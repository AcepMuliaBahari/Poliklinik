<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">
        ...
        <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
            <li>
                <a href="{{ route('admin.home') }}" class="mr-4 hover:underline md:mr-6 ">Home</a>
            </li>
            <li>
                <a href="{{ route('data.dokter') }}" class="mr-4 hover:underline md:mr-6">Dokter</a>
            </li>
            <li>
                <a href="{{ route('data.pasien') }}" class="mr-4 hover:underline md:mr-6 ">Pasien</a>
            </li>
            <li>
