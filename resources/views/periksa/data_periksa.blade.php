            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form method="POST" action="{{ route('simpan.periksa') }}">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="obat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Biaya Periksa</label>
                            <input type="text" name="biaya_periksa"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Biaya periksa" required="">
                        </div>
      ...
      <table id="myTable" class="display w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <caption>List Periksa</caption>
                ...
                <tbody >
                    ...
                    <td class="px-6 py-4 ">Rp.{{ number_format($item->biaya_periksa, 0, ',', '.') }}</td>
