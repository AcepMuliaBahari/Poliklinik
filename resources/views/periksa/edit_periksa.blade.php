        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full  p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form id="myForm" method="POST" action="{{ route('update.periksa', ['id' => $periksa->id]) }}" class="forms-sample">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Biaya Periksa</label>
                            ...
                            @error('biaya_periksa') is-invalid @enderror value="{{ $periksa->biaya_periksa }}">
                            @error('biaya_periksa')
                            <span class="text-danger">{{ $message }}</span>
