        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full  p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">               
                    ...
                    <form id="myForm" method="POST" action="{{ route('update.dokter') }}" class="forms-sample">
                        ...
                        <div class="mb-3">
                            <x-input-label for="exampleInputEmail1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat</x-input-label>
                            <input type="text" name="alamat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" @error('alamat') is-invalid @enderror value="{{ $dokter->alamat }}">
                            @error('alamat')
                            <span class="text-danger">{{ $message }}</span>
